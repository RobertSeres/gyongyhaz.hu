...
## 2025-05-14 - Structural Landmark Pattern for Legacy Monoliths
...
**Action:** Always check for basic accessibility landmarks (`<main>`, `<footer>`) and skip links first when auditing static sites.
